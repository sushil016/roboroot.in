                          ...
                          <div className="min-w-0 flex flex-col gap-3">
                            <div>
                              <Link
                                ...
                                className="text-base font-bold text-[#222222] hover:text-[var(--brand-primary)] transition-colors line-clamp-2"
                              >
                                {item.component.name}
                              </Link>
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-3">
                              ...
                              <div className="flex items-center overflow-hidden rounded-xl border border-[#D2D2D0]">
                                <button
                                  ...
                                  className="h-9 w-9 flex items-center justify-center text-zinc-600 hover:bg-[#E8E8E6] disabled:opacity-40 transition-colors"
                                >
                                ...
                                <input
                                  ...
                                  className="w-12 h-9 text-center text-sm font-bold text-[#222222] bg-white outline-none border-x border-[#D2D2D0]"
                                  type="number"
                                  min="1"
